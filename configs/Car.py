...
fine_tune = False
exp_name = "Car"
fine_tune_iters = 500000
dataset_type = 'NerfDataset'
if fine_tune:
    dataset_dir = './data/fine_tune/'+exp_name
else:
    dataset_dir = './data/nerf_synthetic_data/'+exp_name
...
dataset = dict(
    train=dict(
        ...
        batch_size=4096,
        mode='train',
        data_skip=2 if render_flag==0 else 1,
