...
class NerfDataset():
    def __init__(self,root_dir, batch_size, mode='train', H=0, W=0, correct_pose=[1,-1,-1], aabb_scale=None, scale=None, offset=None,
                img_alpha=True,to_jt=True, have_img=True, preload_shuffle=True, data_skip=1, render_start_id=None, render_end_id=None):
        ...
        self.render_start_id = render_start_id
        self.render_end_id = render_end_id
    ...
    def load_data(self,root_dir=None):
        ...
        frames=json_data['frames'][::self.data_skip]
        if self.mode=="val":
            frames=frames[::10]
